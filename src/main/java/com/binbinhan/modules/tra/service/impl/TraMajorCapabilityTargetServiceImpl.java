...
import com.binbinhan.modules.tra.dao.TraMajorCapabilityTargetDao;
import com.binbinhan.modules.tra.entity.TraMajorCapabilityTargetEntity;
 ...
 */
@Service("traMajorCapabilityTargetService")
public class TraMajorCapabilityTargetServiceImpl extends ServiceImpl<TraMajorCapabilityTargetDao, TraMajorCapabilityTargetEntity> implements TraMajorCapabilityTargetService {


    @Override
    public void saveImport(List<TraMajorCapabilityTargetEntity> dataList) {
        String msg = "";
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        QueryWrapper<TraMajorCapabilityTargetEntity> queryWrapper = new QueryWrapper<>();
        queryWrapper.eq(trainingId!=null,"training_id",trainingId);
        queryWrapper.like(StringUtils.isNotBlank(keyword),"title",keyword);
        IPage<TraMajorCapabilityTargetEntity> page = baseMapper.selectPage( new Query<TraMajorCapabilityTargetEntity>().getPage(params),queryWrapper);
